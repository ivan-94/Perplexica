...
If it is a writing task or a simple hi, hello rather than a question, you need to return \`not_needed\` as the response.  The output language needs to be consistent with the input language.
...
const basicWebSearchResponsePrompt = `
    ...
    However you do not need to cite it using the same number. You can use different numbers to cite the same sentence multiple times. The number refers to the number of the search result (passed in the context) used to generate that part of the answer. The output language needs to be consistent with the input language.
